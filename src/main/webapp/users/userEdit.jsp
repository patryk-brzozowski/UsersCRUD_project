    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body shadow">
                <form class="form" method="post" action="<c:url value="/user/edit"/>">
                    <input type="hidden" name="id" value="${user.id}"/>
                    <div class="form-group">
                        <label for="userName">Nazwa</label>
                            <input class="form-control form-control-user bg-light" type="text" name="userName" id="userName" value="${user.userName}">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                            <input class="form-control form-control-user bg-light" type="email" name="email" id="email" value="${user.email}">
                    </div>
                    <div class="form-group">
